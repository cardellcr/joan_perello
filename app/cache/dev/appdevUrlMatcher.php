...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // qui_som
        if (preg_match('#^/(?<_locale>ca|es|en|de)/qui_som$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Web\\WebBundle\\Controller\\DefaultController::qui_somAction',  '_locale' => 'ca',)), array('_route' => 'qui_som'));
        }

        // feines
        if (preg_match('#^/(?<_locale>ca|es|en|de)/feines$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Web\\WebBundle\\Controller\\DefaultController::feinesAction',  '_locale' => 'ca',)), array('_route' => 'feines'));
        }

        // presupost
        if (preg_match('#^/(?<_locale>ca|es|en|de)/presupost$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Web\\WebBundle\\Controller\\DefaultController::presupostAction',  '_locale' => 'ca',)), array('_route' => 'presupost'));
        }

        // new_message
        if (preg_match('#^/(?<_locale>ca|es|en|de)/new_message$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Web\\WebBundle\\Controller\\DefaultController::new_messageAction',  '_locale' => 'ca',)), array('_route' => 'new_message'));
        }
